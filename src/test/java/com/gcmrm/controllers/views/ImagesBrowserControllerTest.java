...
/**
 * Test for the controller for image browser page interface.
 */
public class ImagesBrowserControllerTest extends ApplicationTest {
    /**
     * String image browser view fxml.
     */
    public static final String mainView = "views/ImagesBrowser.fxml";
    ...
    /**
     * Test of the image browser view loading (panel).
     */
    ...
    /**
     * Test of the image browser view loading (controller).
     */
    @Test public void testLoadViewController() {
        // Test if the controller of the gui have been loaded.
        assertTrue("controller must be a HomeController", controller instanceof ImagesBrowserController);
    }
}