...
/**
 * Test for the controller for algo details page interface.
 */
public class AlgoDetailsControllerTest extends ApplicationTest {
    /**
     * String algo details view fxml.
     */
    public static final String mainView = "views/AlgoDetails.fxml";
    ...
    /**
     * Test of the algo details view loading (panel).
     */
    ...
    /**
     * Test of the algo details view loading (controller).
     */
    @Test public void testLoadViewController() {
        // Test if the controller of the gui have been loaded.
        assertTrue("controller must be a HomeController", controller instanceof AlgoDetailsController);
    }
}