...
/**
 * Test for the controller for image correction page interface.
 */
public class ImageCorrectionControllerTest extends ApplicationTest {
    /**
     * String image correction view fxml.
     */
    public static final String mainView = "views/ImageCorrection.fxml";
    ...
    /**
     * Test of the image correction view loading (panel).
     */
    ...
    /**
     * Test of the image correction view loading (controller).
     */
    @Test public void testLoadViewController() {
        // Test if the controller of the gui have been loaded.
        assertTrue("controller must be a HomeController", controller instanceof ImageCorrectionController);
    }
}