...
/**
 * Test for the controller for algo browser page interface.
 */
public class AlgoBrowserControllerTest extends ApplicationTest {
    /**
     * String algo browser view fxml.
     */
    public static final String mainView = "views/AlgoBrowser.fxml";
    ...
    /**
     * Test of the algo browser view loading (panel).
     */
    ...
    /**
     * Test of the algo browser view loading (controller).
     */
    @Test public void testLoadViewController() {
        // Test if the controller of the gui have been loaded.
        assertTrue("controller must be a HomeController", controller instanceof AlgoBrowserController);
    }
}