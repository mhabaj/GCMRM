...
/**
 * Test for the controller for fast mode page interface.
 */
public class FastModeControllerTest extends ApplicationTest {
    /**
     * String fast mode view fxml.
     */
    public static final String mainView = "views/FastMode.fxml";
    ...
    /**
     * Test of the fast mode view loading (panel).
     */
    ...
    /**
     * Test of the fast mode view loading (controller).
     */
    @Test public void testLoadViewController() {
        // Test if the controller of the gui have been loaded.
        assertTrue("controller must be a HomeController", controller instanceof FastModeController);
    }
}